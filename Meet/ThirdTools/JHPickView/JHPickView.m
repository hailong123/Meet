...
- (void)completeBtnClick{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(PickerSelectorIndixString:indexRow:)]) {
        
        [self.delegate PickerSelectorIndixString:fullStr indexRow:self.indexRow];
    }
